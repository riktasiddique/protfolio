                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="{{ route('login') }}" method="POST" id="loginForm">
                            ...
                            <!-- <a class="btn btn-success btn-block" href="">Register</a> -->
                            <p class="text-center ">Don't have an account? <a href="{{ route('register') }}"><span class="text-info"> Register</span></a></p>
                        </form>
                    </div>
                </div>
            </div>
